package br.com.zup.realwave.sales.manager.query.application.controller.helpers
...
import br.com.zup.realwave.sales.manager.domain.Price as DomainPrice
...
private fun toApiPrice(price: DomainPrice): Price = Price(
    amount = price.amount,
    scale = price.scale,
